...
function identifyBehavioralPatterns(subscores) {
  ...
  const { innerVoice, emotionalAcceptance, pastAcceptance, compassionForOthers } = subscores
  ...
  const range =
    Math.max(innerVoice, emotionalAcceptance, pastAcceptance, compassionForOthers) -
  ...
  if (innerVoice > 3.5 && emotionalAcceptance > 3.5 && pastAcceptance > 3.5 && compassionForOthers > 3.5) {
    ...
    [innerVoice, emotionalAcceptance, pastAcceptance, compassionForOthers].filter((s) => s > 3.0).length === 3 &&
    avg >= 2.8
  ) {
  ...
  if (innerVoice < 2.0 && emotionalAcceptance < 2.0 && pastAcceptance < 2.0 && compassionForOthers < 2.0) {
    ...
    [innerVoice, emotionalAcceptance, pastAcceptance, compassionForOthers].filter((s) => s < 2.3).length === 3 &&
    avg < 2.5
  ) {
  ...
  if (range < 0.5 && avg >= 2.3 && avg <= 3.0) {
    ...
    avg <= 3.0 &&
    innerVoice >= 2.5 &&
    emotionalAcceptance >= 2.5 &&
    pastAcceptance >= 2.5 &&
    compassionForOthers >= 2.5
  ) {
